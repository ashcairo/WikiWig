...
//--- put 1 instead of isNAv6 make the sub-folders navigation possible (if somebody finds how to resolve the problem with a less brutal technique ...)
  if (1) {
...
function setIdProperty( id, property, value ) {
  //isNav6     --- put 1 instead of isNAv6 make the sub-folders navigation possible (if somebody finds how to resolve the problem with a less brutal technique ...)
  if (1) {
    var styleObject = document.getElementById( id );
    if (styleObject != null) {
      styleObject = styleObject.style;
